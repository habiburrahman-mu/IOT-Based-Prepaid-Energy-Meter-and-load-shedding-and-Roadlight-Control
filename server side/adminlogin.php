...
if (isset($_SESSION['admin_username']) ){
    header("location: live.php?msg=You're Already logged in");
}
?>
<!doctype html>
<html lang="en">
    ...
    <body>
        <div class="jumbotron">
            ...
            <h3 class="lead" style="text-align: center">Login to Admin panel & monitor every meter in your region</h3>
        </div>
        ...
        if (isset($_POST['submit']) && isset($_POST['user']) && isset($_POST['pass']) ) {
            ...
            if (!empty($username) && !empty($password )) {
                ...
                if (mysqli_num_rows($query_run) > 0) {
                    ...
                    header("location: adminlogin.php?msg=Wrong Username or Password");
                }
            } else {
                header("location: adminlogin.php?msg=Username or Password cannot be empty");
            }
        }
        ?>
